...
public class Snapshot {
    ...
    public Snapshot(String sch, ConnectionManager connectionManager) {
        this.schema = sch;
        this.connectionManager = connectionManager;
    }

    public ArrayList<String> getSchemaTables() throws SQLException {
        PreparedStatement stmt = this.connectionManager.getSQLConnection().prepareStatement("SELECT schemaname, tablename FROM pg_tables WHERE schemaname = ?");
    ...
    public Event getInitialSnapshot(String outputFormat) throws SQLException, IOException {
        ...
        ArrayList<String> pubTables = this.getSchemaTables();
